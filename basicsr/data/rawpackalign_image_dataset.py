...
class RAWPACKAlignImageDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(RAWPACKAlignImageDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        img_lq = extract_bayer_channels(raw_image)
        ...
        if self.opt['phase'] == 'train':
            ...
            # flip, rotation
            img_gt,img_lq,img_mask = numpyaug( [img_gt,img_lq,img_mask], self.opt['use_hflip'], self.opt['use_rot'])
        ...
        # print(img_lq.size())
        # print(img_gt.size())
        return {'lq': img_lq, 'gt': img_gt, 'lq_path': lq_path, 'gt_path': gt_path,'mask':img_mask,'mask_path':mask_path}
